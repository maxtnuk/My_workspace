        ...
        while let Some(e) = window.next() {
            if let Some(r) = e.render_args() {
                ...
                if count < MAXINUM {
                    ...
                    self.current_state.push(machine.current_state);
                    for obstacle in obstacles.iter() {
                        self.current_state.push(obstacle.current_state);
                    }
                }
